...
# 模型2:alexnet
alexnet = models.resnet18(pretrained=False, num_classes=3)  # 加载预训练的alexnet模型
...
model1_name = 'model_1_2'
model2_name = 'model_2_2'
model3_name = 'model_3_2'
model4_name = 'model_4_2'
model5_name = 'model_ensemble_2'
